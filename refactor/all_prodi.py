...
if input_formula == "Baru":
    ...
    # print('selected_formulas_lembaga:', selected_formulas_lembaga)
    
    # Pilih Formula untuk setiap prodi sesuai dengan lembaga prodi tsb
...
# 9. Output Prediksi Pemantauan
    ...
    if input_kriteria == "Jumlah Mahasiswa":
        ...
        # existing_djm.at[index, 'Hitung Persentase Penurunan'] = "Tidak Ada"
