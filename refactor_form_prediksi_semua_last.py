...
input_last_year = st.slider("Masukkan Tahun Sekarang (ex: 2024) : ", min_value=min_year, max_value=max_year)
...
# input_years_to_predict = st.slider("Masukkan Proyeksi Prediksi (Dalam Satuan Tahun) : ", min_value=0, max_value=5)
