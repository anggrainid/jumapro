...
def prediksi_dan_penilaian(data_prodi, input_predict_year, input_last_year, input_years_to_predict, input_kriteria, input_ambang_batas_jumlah, input_ambang_batas_persen, input_fields):
    if input_kriteria == "Jumlah Mahasiswa":
        ...
        data_prodi["Ambang Batas Jumlah Mahasiswa"] = input_ambang_batas_jumlah
        ...
        data_prodi = data_prodi[["Prodi", ]], data_predict_target, ["Ambang Batas Jumlah Mahasiswa",f"Hasil Prediksi Pemantauan ({input_predict_year})" ], data_predict_years, "Tahun Tidak Lolos (Prediksi)"
        data_prodi = data_prodi["Prodi"], data_prodi["f'{input_last_year} (Saat Ini)"], data_predict_target
